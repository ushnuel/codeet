    ...
    <Aux>
      ...
      <Section className='service-products'>
        ...
        >
          <h1>UI/UX Designs</h1>
          <p>
            Website design is where our art meets technology. Speaking of
            creative, customized, unique and innovative web design solutions, we
            are your best choice. <br /> Our team of experienced graphics
            designers are ready to craft the best eye-catching,
            eazy-to-navigate, top quality website designs that will meet your
            business requirements. We utilize the latest trends in website UI/UX
            design to turn your idea into a standard product.
          </p>
        ...
        >
          ...
          <p>
            Tell us about your fascinating business idea, we will effectively
            turn it into a full-fledged software product, in the form of a
            mobile application software. We assure you of a cost effective
            solution for your mobile app development needs. <br /> We seriously
            value long term relationships with our clients, and always provide
            them quality services on a given timeline. We make provision for
            sufficient testing and prototyping until everything is perfect and
            up to mark.
          </p>
        ...
        >
          ...
          <p>
            Createev is envisioned to providing the latest, state-of-the-art web
            development solutions to businesses at a competitive price. We
            heartly value the worth of your investments, which is why our
            professional web development team is here to provide you with a host
            of top notch services. <br /> Our passion is blended in aesthetics,
            stylish and robust website designs that will efficiently elevate
            your business to unprecedented heights of success.
          </p>
        ...
        >
          ...
          <p>
            Lets rally a pool of clientele to your door steps. A strong customer
            base and continous revenue streams is the beating heart of every
            business. We provide you with the best digital marketing services
            needed to take your business to the next level. <br /> Our wealth of
            experience in digital marketing speaks volume. Give us a buzz, and
            we take care of all the digital solutions for your brand, be it
            designs, content or social media strategy
          </p>
          <h3>
            We are prepared to meet your needs in these key areas of Digital
            Marketing
          </h3>
          <ul>
            <li>
      ...
      >
        <p>
          If you think that we’d be a good fit to solve your challenge, just
          contact us! <br /> We can’t wait to start working with you!
        </p>
        <Link to='/contact-us'>
